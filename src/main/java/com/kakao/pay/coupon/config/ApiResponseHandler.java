...
import com.kakao.pay.coupon.dto.ApiErrorResponse;
import com.kakao.pay.coupon.dto.ApiResponse;
...
@ControllerAdvice(basePackages = {"com.kakao.pay.coupon.controller.api"})
